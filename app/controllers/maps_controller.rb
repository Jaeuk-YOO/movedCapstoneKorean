class MapsController < ApplicationController
    ...
    def recommend_test
        ...
        @expression_korean = {"따뜻한 아메리카노 한 잔 주세요.":"Please give me 1 hot coffee", "아이스 아메리카노 두 잔 주세요.":"Please give me 2 ice coffees", "카페인 없는 음료 있어요?":"Do you have non-caffeinated drinks?", "여기서 먹고 갈게요.":"I'll drink it here.", "테이크 아웃할게요.":"I'd like this to go", "영수증은 버려주세요.":"Please throw away my receipt", "와이파이 되나요?":"Do you have wifi?", "와이파이 비밀번호가 뭐예요?":"What's the wifi password?", "콘센트 있어요?":"Is there an outlet?", "콘센트 어디에 있어요?":"Where are your electrical outlets?"}
        @expression_korean_experience = {"어떻게 이용하나요?":"How can I use this? play?", "한 시간에 얼마인가요?":"How much is it per hour?", "짐은 어디에 두나요? 짐은 어디에 보관하나요?":"Where can I keep my luggage?", "한 시간 더 이용하고 싶어요. 추가 요금이 얼마인가요?":"I'd like to play it for one more hour. (how much is it cost?) How much extra would it be"}
